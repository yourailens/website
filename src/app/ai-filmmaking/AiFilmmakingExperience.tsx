...
import { AI_FILMMAKING as C, AI_FILMMAKING_REEL } from "@/data/ai-filmmaking-copy";
    ...
    <header className="overflow-hidden border-b border-blue-100 bg-[#f8fbff]">
      <div className={`${PAGE} pb-10 pt-12 text-center lg:pb-12 lg:pt-16`}>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          <StickyLabel tone="blue">SCENE 01</StickyLabel>
          <StickyLabel className="rotate-[3deg]">now in production</StickyLabel>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-6 pb-10 lg:px-10">
        <div className="relative overflow-hidden rounded-[1.75rem] border border-blue-200/80 bg-gradient-to-br from-white via-blue-50/70 to-slate-100 p-2 shadow-[0_28px_70px_-32px_rgba(37,99,235,0.45)] ring-1 ring-blue-100/70 sm:p-3">
          ...
          <div className="flex items-center justify-between gap-4 px-3 pb-2 pt-1 sm:px-4">
            ...
            <p className="text-[8px] font-medium uppercase tracking-[0.2em] text-blue-600/70">AI Filmmaking</p>
          </div>
...
export default function AiFilmmakingExperience() {
  return (
    <div className="min-h-screen bg-white font-body text-slate-900">
      ...
      <SectionShell>
        <SectionHead eyebrow={C.craft.eyebrow} title={C.craft.title} body={C.craft.body} note="taste still wins" />
      ...
      <SectionShell dark>
        <SectionHead
          light
          eyebrow={C.reel.eyebrow}
          title={C.reel.title}
          body={C.reel.body}
        />
        <div className="relative mt-12 pb-8 lg:pb-20">
          <div className="relative aspect-video overflow-hidden border border-white/10 bg-black shadow-[0_32px_80px_-42px_rgba(0,0,0,0.85)] lg:ml-[10%] lg:w-[90%]">
            <DeferredVideo src="/videos/d&d.mp4" poster="/videos/dnd-poster.jpg" className="absolute inset-0 h-full w-full object-cover" />
          </div>
          <div className="relative z-10 mx-4 -mt-10 overflow-hidden border border-white/15 bg-slate-950/90 px-6 py-7 backdrop-blur-sm sm:mx-8 sm:-mt-14 lg:absolute lg:bottom-0 lg:left-0 lg:m-0 lg:w-[46%] lg:px-10 lg:py-10">
            <p className="font-mono text-[9px] uppercase tracking-[0.28em] text-blue-300">Featured · Narrative</p>
            <p className="mt-4 text-[clamp(2rem,4vw,3.6rem)] font-light leading-[0.95] text-white" style={{ letterSpacing: "-0.05em" }}>
              AI <span className="font-semibold text-blue-300">FILMS</span>
            </p>
      ...
      <SectionShell tint>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3 sm:gap-4">
          {C.process.steps.slice(0, 3).map((step) => (
            <div
              key={step.no}
              className="rotate-[-1deg] border border-blue-200 bg-white px-5 py-3 shadow-sm sm:px-6"
            >
              <p className="font-mono text-[8px] tracking-[0.2em] text-blue-500">{step.no}</p>
              <p className="mt-1 text-lg font-light text-slate-900" style={HAND}>
                {step.label}
              </p>
            </div>
          ))}
      ...
      <SectionShell>
        ...
        <div className="mt-12 flex flex-wrap items-center gap-4 border-t border-blue-100 pt-10">
          <p className="text-sm font-light text-slate-600">Also shipping commercial work?</p>
          <Link
            href="/ai-ads"
